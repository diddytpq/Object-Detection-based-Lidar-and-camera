...
#ifndef OPENROBOT_VESC_DRIVER_VESC_PACKET_FACTORY_H_
#define OPENROBOT_VESC_DRIVER_VESC_PACKET_FACTORY_H_
...
#endif // OPENROBOT_VESC_DRIVER_VESC_PACKET_FACTORY_H_
